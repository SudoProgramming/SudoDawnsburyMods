    ...
    public static class EquipmentGunsAndGears
    {
        ...
        public static void RegisterItems()
        {
            ...
            ModManager.RegisterNewItemIntoTheShop("Coat Pistol", itemName =>
                new Item(itemName, IllustrationName.Unknown, "coatpistol", 0, 3, Trait.FatalD8, FirearmTrait, Trait.Simple, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d4", DamageKind.Piercing)
                        .WithRangeIncrement(6)));

            //  - Fire Lance
            ModManager.RegisterNewItemIntoTheShop("Fire Lance", itemName =>
               new Item(itemName, IllustrationName.Unknown, "firelance", 0, 3, Trait.FatalD10, FirearmTrait, Trait.Simple, Trait.Reload2, Trait.TwoHanded)
            ...
            ModManager.RegisterNewItemIntoTheShop("Flintlock Musket", itemName =>
               new Item(itemName, IllustrationName.Unknown, "flintlockmusket", 0, 4, Trait.FatalD10, FirearmTrait, Trait.Simple, Trait.Reload1, Trait.TwoHanded)
                   .WithWeaponProperties(new WeaponProperties("1d6", DamageKind.Piercing)
            ...
            ModManager.RegisterNewItemIntoTheShop("Flintlock Pistol", itemName =>
               new Item(itemName, IllustrationName.Unknown, "flintlockpistol", 0, 3, Trait.FatalD8, FirearmTrait, Trait.Simple, Trait.Reload1)
                   .WithWeaponProperties(new WeaponProperties("1d4", DamageKind.Piercing)
            ...
            ModManager.RegisterNewItemIntoTheShop("Hand Cannon", itemName =>
               new Item(itemName, IllustrationName.Unknown, "handcannon", 0, 3, Trait.FatalD8, FirearmTrait, Trait.Simple, Trait.Reload1)
            ...
            ModManager.RegisterNewItemIntoTheShop("Long Air Repeater", itemName =>
               new Item(itemName, IllustrationName.Unknown, "longairrepeater", 0, 5, Trait.Repeating, FirearmTrait, Trait.Simple)
                   .WithWeaponProperties(new WeaponProperties("1d4", DamageKind.Piercing)
            ...
            ModManager.RegisterNewItemIntoTheShop("Arquebus", itemName =>
                new Item(itemName, IllustrationName.Unknown, "arquebus", 0, 5, Trait.FatalD12, FirearmTrait, Trait.Martial, Trait.Reload1, Trait.TwoHanded)
            ...
            ModManager.RegisterNewItemIntoTheShop("Blunderbuss", itemName =>
                new Item(itemName, IllustrationName.Unknown, "blunderbuss", 0, 4, FirearmTrait, Trait.Martial, Trait.Reload1, Trait.TwoHanded)
                    .WithWeaponProperties(new WeaponProperties("1d8", DamageKind.Piercing)
                        .WithRangeIncrement(8)));
            ...
            ModManager.RegisterNewItemIntoTheShop("Clan Pistol", itemName =>
                new Item(itemName, IllustrationName.Unknown, "clanpistol", 0, 0, Trait.Dwarf, Trait.FatalD10, FirearmTrait, Trait.Martial, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d6", DamageKind.Piercing)
            ...
            ModManager.RegisterNewItemIntoTheShop("Double-barreled Musket", itemName =>
                new Item(itemName, IllustrationName.Unknown, "doublebarreledmusket", 0, 5, Trait.FatalD10, FirearmTrait, Trait.Martial, Trait.Reload1, Trait.TwoHanded)
                    .WithWeaponProperties(new WeaponProperties("1d6", DamageKind.Piercing)
                        .WithRangeIncrement(12)));
            ...
            ModManager.RegisterNewItemIntoTheShop("Double-barreled Pistol", itemName =>
                new Item(itemName, IllustrationName.Unknown, "doublebarreledpistol", 0, 4, Trait.FatalD8, FirearmTrait, Trait.Martial, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d4", DamageKind.Piercing)
                        .WithRangeIncrement(6)));
            ...
            ModManager.RegisterNewItemIntoTheShop("Dragon Mouth Pistol", itemName =>
                new Item(itemName, IllustrationName.Unknown, "dragonmouthpistol", 0, 5, Trait.FatalD8, FirearmTrait, Trait.Martial, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d6", DamageKind.Piercing)
            ...
            ModManager.RegisterNewItemIntoTheShop("Dueling Pistol", itemName =>
                new Item(itemName, IllustrationName.Unknown, "duelingpistol", 0, 6, Trait.FatalD10, FirearmTrait, Trait.Martial, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d6", DamageKind.Piercing)
                        .WithRangeIncrement(12)));
            ...
            ModManager.RegisterNewItemIntoTheShop("Harmona Gun", itemName =>
                new Item(itemName, IllustrationName.Unknown, "harmonagun", 0, 5, FirearmTrait, Trait.Martial, Trait.Reload1, Trait.TwoHanded)
            ...
            ModManager.RegisterNewItemIntoTheShop("Jezail", itemName =>
                new Item(itemName, IllustrationName.Unknown, "jezail", 0, 5, FirearmTrait, Trait.Martial, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d8", DamageKind.Piercing)
            ...
            ModManager.RegisterNewItemIntoTheShop("Mithral Tree", itemName =>
                new Item(itemName, IllustrationName.Unknown, "mithraltree", 0, 5, Trait.Elf, Trait.FatalD10, FirearmTrait, Trait.Martial, Trait.Reload1, Trait.TwoHanded)
                    .WithWeaponProperties(new WeaponProperties("1d6", DamageKind.Piercing)
                        .WithRangeIncrement(30)));
            ...
            ModManager.RegisterNewItemIntoTheShop("Pepperbox", itemName =>
                new Item(itemName, IllustrationName.Unknown, "pepperbox", 0, 6, Trait.FatalD8, FirearmTrait, Trait.Martial, Trait.Reload1)
                    .WithWeaponProperties(new WeaponProperties("1d4", DamageKind.Piercing)
                        .WithRangeIncrement(12)));
